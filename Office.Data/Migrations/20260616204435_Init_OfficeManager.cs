...
{
    /// <inheritdoc />
    public partial class Init_OfficeManager : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Address = table.Column<int>(type: "int", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TransferOrders_Products_ProductId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TransferOrders_ProductId",
                table: "TransferOrders",
                column: "ProductId");
